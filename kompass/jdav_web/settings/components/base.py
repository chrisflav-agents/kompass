...
INSTALLED_APPS = [
    "kompass.test_data.apps.TestDataConfig",
    "kompass.logindata.apps.LoginDataConfig",
    "kompass.contrib.apps.ContribConfig",
    "kompass.startpage.apps.StartpageConfig",
    "kompass.material.apps.MaterialConfig",
    "kompass.members.apps.MembersConfig",
    "kompass.mailer.apps.MailerConfig",
    "kompass.finance.apps.FinanceConfig",
    "kompass.ludwigsburgalpin.apps.LudwigsburgalpinConfig",
    #'easy_select2',
...
MIDDLEWARE = [
    ...
    "kompass.jdav_web.middleware.ForceLangMiddleware",
...
ROOT_URLCONF = "kompass.jdav_web.urls"
...
WSGI_APPLICATION = "kompass.jdav_web.wsgi.application"
